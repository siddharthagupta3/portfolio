...
const Hero = () => {
  ...
  return (
    <>
      <section className="min-h-screen flex items-center justify-center bg-transparent text-white pt-44 lg:pt-80">
        <div className="container mx-auto px-4 text-center relative z-10 translate-y-12 lg:translate-y-28">
          <motion.div
