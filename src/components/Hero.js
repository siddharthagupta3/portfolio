...
export default function Hero() {
  ...
  return (
    ...
    >
      ...
      <div className="md:hidden container w-full flex justify-center px-12 mb-8 relative z-20 shrink-0">
        <StackHeading />
      </div>

      {/* Desktop: position StackHeading under the Navigate button (calculates horizontal center) */}
      <div className="hidden md:block absolute left-0 right-0 z-20 pointer-events-none" style={{ top: 'calc(var(--header-height,5rem) + 1.75rem)' }}>
      ...
      <div
        ref={containerRef}
        className="w-full max-w-full relative z-10 shrink-0 max-md:h-[calc(100dvh-var(--header-height,4.5rem)-8rem)] max-md:min-h-[380px] md:min-h-[640px] mt-8 md:mt-12"
      >
        {/* Connections */}
